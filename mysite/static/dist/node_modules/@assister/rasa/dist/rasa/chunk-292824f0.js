...
const patchEsm = () => {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_rasa('./css-shim-3ea8955c-3ea8955c.js');
    }
...
const patchBrowser = async () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await __sc_import_rasa('./dom-860d8016-860d8016.js');
        }
    ...
    if ((BUILD.lazyLoad || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !Cstr.$isStyleRegistered$ && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && (shadowCssPolyfill || runtimeScopedCss)) {
                style = await __sc_import_rasa('./shadow-css-9e778f69-c68d0961.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
export { Build as B, Host as H, patchEsm as a, bootstrapLazy as b, config as c, getIonMode as d, createEvent as e, getElement as f, globals as g, h, isPlatform as i, readTask as j, getConnect as k, getAssetPath as l, getMode as m, patchBrowser as p, registerInstance as r, writeTask as w };
