import { w as writeTask } from './chunk-292824f0.js';
...
const iosTransitionAnimation = () => __sc_import_rasa('./ios.transition-92f58f45.js');
const mdTransitionAnimation = () => __sc_import_rasa('./md.transition-b173fdc5.js');
...
const animation = async (animationBuilder, opts) => {
    ...
    const trans = await __sc_import_rasa('./index-266bb658.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
