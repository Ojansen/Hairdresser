...
class Toast {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [mode]: true }, __chunk_3.createColorClasses(this.color), __chunk_3.getClassMap(this.cssClass), { 'toast-translucent': this.translucent })
        };
    }
...
const buttonClass = (button) => {
    return Object.assign({ 'toast-button': true, 'toast-button-icon-only': button.icon !== undefined && button.text === undefined, [`toast-button-${button.role}`]: button.role !== undefined, 'ion-focusable': true, 'ion-activatable': true }, __chunk_3.getClassMap(button.cssClass));
};
