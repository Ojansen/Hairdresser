...
class Spinner {
    ...
    getName() {
        const name = this.name || __chunk_1.config.get('spinner');
    ...
    hostData() {
        const mode = __chunk_1.getIonMode(this);
        return {
            class: Object.assign({}, __chunk_3.createColorClasses(this.color), { [mode]: true, [`spinner-${this.getName()}`]: true, 'spinner-paused': !!this.paused || __chunk_1.config.getBoolean('_testing') })
        };
    }
    __stencil_render() {
