...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-6e63d59e.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-a1d95ba4.js')); });
...
const animation = async (animationBuilder, opts) => {
    ...
    const trans = await new Promise(function (resolve) { resolve(require('./index-6c98731b.js')); }).then(mod => mod.create(animationBuilder, opts.baseEl, opts));
