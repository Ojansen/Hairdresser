...
class ActionSheet {
    ...
    hostData() {
        ...
        return {
            ...
            class: Object.assign({ [mode]: true }, __chunk_3.getClassMap(this.cssClass), { 'action-sheet-translucent': this.translucent })
        };
    }
    __stencil_render() {
        const mode = __chunk_1.getIonMode(this);
...
const buttonClass = (button) => {
    return Object.assign({ 'action-sheet-button': true, 'ion-activatable': true, [`action-sheet-${button.role}`]: button.role !== undefined }, __chunk_3.getClassMap(button.cssClass));
};
