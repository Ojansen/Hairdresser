...
class Router {
    ...
    componentDidLoad() {
        window.addEventListener('ionRouteRedirectChanged', __chunk_2.debounce(this.onRedirectChanged.bind(this), 10));
        window.addEventListener('ionRouteDataChanged', __chunk_2.debounce(this.onRoutesChanged.bind(this), 100));
    }
    onPopState() {
