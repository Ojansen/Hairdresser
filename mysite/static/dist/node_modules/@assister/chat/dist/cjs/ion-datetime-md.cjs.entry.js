...
class Datetime {
    ...
    validateColumn(columns, name, index, min, max, lowerBounds, upperBounds) {
        ...
        const selectedIndex = column.selectedIndex = __chunk_2.clamp(indexMin, column.selectedIndex, indexMax);
    ...
    render() {
        ...
        __chunk_2.renderHiddenInput(true, el, this.name, this.value, this.disabled);
