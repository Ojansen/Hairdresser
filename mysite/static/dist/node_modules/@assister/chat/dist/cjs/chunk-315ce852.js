...
const present = async (overlay, name, iosEnterAnimation, mdEnterAnimation, opts) => {
    ...
    const animationBuilder = (overlay.enterAnimation)
        ...
        : __chunk_1.config.get(name, overlay.mode === 'ios' ? iosEnterAnimation : mdEnterAnimation);
...
const dismiss = async (overlay, data, role, name, iosLeaveAnimation, mdLeaveAnimation, opts) => {
    ...
    try {
        ...
        const animationBuilder = (overlay.leaveAnimation)
            ...
            : __chunk_1.config.get(name, overlay.mode === 'ios' ? iosLeaveAnimation : mdLeaveAnimation);
...
const overlayAnimation = async (overlay, animationBuilder, baseEl, opts) => {
    ...
    const animation = await new Promise(function (resolve) { resolve(require('./index-6c98731b.js')); }).then(mod => mod.create(animationBuilder, aniRoot, opts));
    overlay.animation = animation;
    if (!overlay.animated || !__chunk_1.config.getBoolean('animated', true)) {
...
const safeCall = (handler, arg) => {
    if (typeof handler === 'function') {
        const jmp = __chunk_1.config.get('_zoneGate', defaultGate);
        return jmp(() => {
            try {
                return handler(arg);
            }
