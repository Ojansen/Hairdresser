    ...
    componentDidLoad() {
        rIC(() => {
            ...
            if (!config.getBoolean('_testing')) {
                import('./tap-click-201d849a.js').then(module => module.startTapClick(config));
            }
            if (config.getBoolean('statusTap', isHybrid)) {
                import('./status-tap-202f5176.js').then(module => module.startStatusTap());
            }
            if (config.getBoolean('inputShims', needInputShims())) {
                import('./input-shims-6455a8e4.js').then(module => module.startInputShims(config));
            }
            if (config.getBoolean('hardwareBackButton', isHybrid)) {
                import('./hardware-back-button-fcf38822.js').then(module => module.startHardwareBackButton());
            }
            import('./focus-visible-30ddc1ea.js').then(module => module.startFocusVisible());
        });
    }
    hostData() {
...
class Card {
    ...
    hostData() {
        const mode = getIonMode$1(this);
        return {
            class: Object.assign({ [mode]: true }, createColorClasses$1(this.color), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() })
        };
    }
    __stencil_render() {
...
class Content {
    ...
    render() {
        ...
        this.resize();
        return (h(Host, { class: Object.assign({}, createColorClasses$1(this.color), { [mode]: true, 'content-sizing': hostContext('ion-popover', this.el), 'overscroll': !!this.forceOverscroll }), style: {
...
class ToolbarTitle {
    ...
    hostData() {
        ...
        return {
            class: Object.assign({ [mode]: true, [`title-${mode}`]: true }, createColorClasses$1(this.color))
        };
    }
    __stencil_render() {
        return [
...
class Toolbar {
    ...
    render() {
        ...
        return (h(Host, { class: Object.assign({ [mode]: true }, childStyles, createColorClasses$1(this.color)) }, h("div", { class: "toolbar-background" }), h("div", { class: "toolbar-container" }, h("slot", { name: "start" }), h("slot", { name: "secondary" }), h("div", { class: "toolbar-content" }, h("slot", null)), h("slot", { name: "primary" }), h("slot", { name: "end" }))));
    }
    get el() { return getElement(this); }
