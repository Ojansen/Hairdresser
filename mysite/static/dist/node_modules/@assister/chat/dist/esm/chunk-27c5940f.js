import { w as writeTask } from './chunk-66bb1373.js';
...
const iosTransitionAnimation = () => import('./ios.transition-bdc3a806.js');
const mdTransitionAnimation = () => import('./md.transition-3ed08426.js');
...
const animation = async (animationBuilder, opts) => {
    ...
    const trans = await import('./index-d3aa5dba.js').then(mod => mod.create(animationBuilder, opts.baseEl, opts));
